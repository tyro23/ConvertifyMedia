export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      ...
      <p>
        At ConvertifyMedia, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          ak23kansal@gmail.com.
        </p>
      </div>

      <p>
        By using ConvertifyMedia, you agree to the practices outlined in this Privacy
